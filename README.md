...
I'm a **critical-care paramedic** with health-sciences degrees who builds open-source tools to answer one question: **can you actually trust what an AI says in a high-stakes domain?**

My edge is the overlap — real clinical judgment + AI fluency — so I evaluate medical and health-finance AI the way a domain expert would, not just a benchmark script. The thread through all my work is **calibration and honest evaluation**: not just *is the model right*, but *does it deserve your trust?*
...
### 🧰 Toolbelt
`Python` · `NumPy` / `pandas` · `scikit-learn` · `matplotlib` · evaluation & benchmark design · calibration · turning messy domain rules into testable ground truth — plus a clinical and health-systems background most data folks don't have.

### 📫 Reach me
[LinkedIn](https://www.linkedin.com/in/noah-spiroff-386136414/) · spiroff.noah@yahoo.com
